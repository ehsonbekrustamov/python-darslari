# -*- coding: utf-8 -*-
"""
Created on Tue Mar  5 17:28:17 2024

@author: Rustamov
"""

#1. Foydalanuvchidan juft son kiritishni so'rang. Agar foydalanuvchi juft son
...
#2.Foydalanuvchi yoshini so'rang, va muzeyga kirish uchun chipta narhini 
...
son2 = float(input('Istalgan son kiriting'))
if son1 == son2:
    print(f"sonlar teng: {son1} = {son2}")
elif son1 > son2:
    print(f"{son1} katta {son2}")
else:
    print(f"{son1} kichik {son2}")
...
mahsulotlar = ['kartoshka','piyoz','sabzi','guruch','mosh','lovya','grechka',
         'makaron']
savat = []
for n in range(5):
...
for mahsulot in savat:
    if mahsulot in mahsulotlar :
        print(f'{mahsulot} dan do\'konimizda bor')
    else:
        print(f'{mahsulot} mahsulotidan do\'konomizda yo\'q')

#5. Yuqoridagi dasturni quyidagicha o'zgartiring: foydalanuvchidan 5 ta mahsulot 
...
# degan ro'yxatga qo'shing.  Agar mavjud_emas ro'yxati bo'sh bo'lsa, "Siz 
# so'ragan barcha mahsulotlar do'konimizda bor" degan xabarni, aks holda esa 
...
foydalanuvchilar = ['Siroj','Yunus','Xasanboy','Bobur','Jamshid']
...
#7. Foydalanuvchidan biror butun son kiritishni so'rang. Foydalanuvchi kiritgan
#   sonni 2 da 10 gacha bo'lgan sonlardan qay biriga qoldiqsiz bo'linishini 
#   konsolga chiqaring. 
son1 = int(input('Butun son kiriting:'))
for son2 in range(2,10):
    if son1 % son2:
        print(f'{son1} qoldiqsiz bo\'linmaydi {son2}')
    else:
        print(f'Bu son {son2}')
